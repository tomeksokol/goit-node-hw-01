...
async function addContact(name, email, phone) {
  try {
    ...
    if (
      ...
      return console.warn("This name already exist".yellow);

    if (contacts.find((contact) => contact.email === email))
      return console.warn("This email already exist".yellow);

    if (contacts.find((contact) => contact.phone === phone))
      return console.warn("This phone already exist".yellow);
